...
//        $nonLocalizedUrl = $this->getNonLocalizedURL($noQueryUrl);
        ...
        // check if this url is a translated url
        foreach ($this->translatedRoutes as $translatedRoute) {
//            $routeName = $this->getURLFromRouteNameTranslated($locale, $translatedRoute, $attributes); // if no fixed, uncomment
            // linhnt.aim@outlook.com
            $routeName = $this->getURLFromCacheRouteNameTranslated($locale, $translatedRoute, $attributes);
            if ($routeName === false) {
                $routeName = $this->getURLFromRouteNameTranslated($locale, $translatedRoute, $attributes);
            }

            if ($routeName == $noQueryUrl) {
            // end fixed // if no fixed, delete
