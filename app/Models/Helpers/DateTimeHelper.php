...
class DateTimeHelper
{
    ...
    private function __construct() {
        $timeZone = session('localization.timezone');
    ...
    {
        return trans('datetime.long_date_' . session('localization.long_date_format'), $this->getBags($time));
    }

    public function shortDate($time = 'now')
    {
        return trans('datetime.short_date_' . session('localization.short_date_format'), $this->getBags($time));
    }

    public function longTime($time = 'now')
    {
        return trans('datetime.long_time_' . session('localization.long_time_format'), $this->getBags($time));
    }

    public function shortTime($time = 'now')
    {
        return trans('datetime.short_time_' . session('localization.short_time_format'), $this->getBags($time));
    }
    ...
    {
        return trans('datetime.long_date_' . session('localization.long_date_format'), self::getFormatBags());
    }

    public static function longDateJsFormat()
    {
        return trans('datetime.long_date_' . session('localization.long_date_format'), self::getMomentJsFormatBags());
    }

    public static function shortDateFormat()
    {
        return trans('datetime.short_date_' . session('localization.short_date_format'), self::getFormatBags());
    }

    public static function shortDateJsFormat()
    {
        return trans('datetime.short_date_' . session('localization.short_date_format'), self::getMomentJsFormatBags());
    }

    public static function shortDatePickerJsFormat()
    {
        return trans('datetime.short_date_' . session('localization.short_date_format'), self::getDatePickerJsFormatBags());
    }

    public static function longTimeFormat()
    {
        return trans('datetime.long_time_' . session('localization.long_time_format'), self::getFormatBags());
    }

    public static function longTimeJsFormat()
    {
        return trans('datetime.long_time_' . session('localization.long_time_format'), self::getMomentJsFormatBags());
    }

    public static function shortTimeFormat()
    {
        return trans('datetime.short_time_' . session('localization.short_time_format'), self::getFormatBags());
    }

    public static function shortTimeJsFormat()
    {
        return trans('datetime.short_time_' . session('localization.short_time_format'), self::getMomentJsFormatBags());
    }
