...
return [
    ...
    'settings' => [
        ...
        'kses_xhtml_strict' => [ // strict: - iframe + style, transitional: + iframe - style
            'HTML.Doctype' => 'XHTML 1.0 Strict',
            'Attr.EnableID' => true,
            'HTML.Allowed' => 'address,a[href|rel|rev|name],abbr,acronym,b,big,
                blockquote[cite],br,caption,cite,code,col[align|charoff|span|valign|width],colgroup[align|charoff|span|valign|width],
                del,dd,dfn,div,dl,dt,em,h1,h2,h3,h4,h5,h6,hr,i,img[alt|height|longdesc|src|width],ins[cite],kbd,li,
                p,pre,q[cite],samp,span,small,strong,sub,sup,table[border|cellpadding|cellspacing|rules|summary|width],tbody[charoff|valign],
                td[abbr|charoff|colspan|rowspan|scope|valign],tfoot[charoff|valign],
                th[abbr|align|charoff|colspan|rowspan|scope|valign],thead[align|charoff|valign],
                tr[align|charoff|valign],tt,ul,ol,var,
                *[style],*[id],*[class],*[dir],*[lang],*[xml:lang],*[title]',
            'CSS.AllowedProperties' => 'text-align,margin,color,float,' .
                'border,background,background-color,border-bottom,border-bottom-color,' .
                'border-bottom-style,border-bottom-width,border-collapse,border-color,border-left,' .
        ...
        'blog' => [ // + iframe + style
            ...
            'AutoFormat.RemoveEmpty' => true,
            'HTML.SafeIframe' => true,
            'URI.SafeIframeRegexp' => '%^(http://|https://|//)(www.youtube.com/embed/|player.vimeo.com/video/|www.dailymotion.com/embed/video/|www.onlinequizcreator.com|www.slideshare.net/slideshow/embed_code/)%',
        ],
        ...
        'question' => [
            'HTML.Allowed' => 'div[style],b,strong,em,i,u,strike,sub,sup,ul,ol,li,p[style]',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align',
            'AutoFormat.AutoParagraph' => true,
            'AutoFormat.RemoveEmpty' => true,
        ],
