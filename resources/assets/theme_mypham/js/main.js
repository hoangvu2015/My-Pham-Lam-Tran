...
$(function(){
	...
	$('#active-bg').remove();
	$('head')
	.append('<link rel="stylesheet" id="active-bg" href="resources/assets/theme_mypham/css/bg/'+get_cookie+'.css">');
	...
	$("#sideWidget div.bgPatterns").find('a').bind('click', function(e) {
		...
		$('head')
		.append('<link rel="stylesheet" id="active-bg" href="resources/assets/theme_mypham/css/bg/'+bgName+'.css">');
	});
});
/*=========== end it ==========*/
