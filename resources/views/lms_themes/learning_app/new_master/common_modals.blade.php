<div id="modal-loading" class="modal fade" tabindex="-1" role="dialog" data-focus-on="input:first">
    <img src="{{url()}}/public/reload.svg" alt="">
</div>
...
<script>
    ...
    function openLoading() {
        var alertModal=jQuery('#modal-loading');
