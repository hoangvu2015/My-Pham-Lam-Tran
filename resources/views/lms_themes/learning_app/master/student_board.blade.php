        ...
        <div class="container parallax-layer" data-opacity="true">
            <div class="media v-middle">
                <div class="media-left text-center">
                    <a href="{{ localizedURL('student/{id?}', ['id' => $student_profile->id]) }}">
                ...
                <div class="media-body">
                    ...
                    <p class="text-subhead">
                        @section('public_profile_link')
                            <a class="text-white text-underline" href="{{ localizedURL('student/{id?}', ['id' => null]) }}">{{ trans('form.action_view') }} {{ trans('pages.my_public_profile') }}</a>
                        @show
                    </p>
                </div>
                <div class="media-right">
                    <span class="label bg-blue-500">{{ trans('roles.student') }}</span>
                </div>
            </div>
        </div>
    </div>
