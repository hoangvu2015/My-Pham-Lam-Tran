                ...
                <table cellpadding="0" cellspacing="0"  width="100%" align="center">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">
                            Học tiếng anh trực tuyến với gia sư
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td>
                <table width="100%" align="justify" style="color: #384047; margin: 0 auto;">
                    ...
                    <tr>
                        <td>Cảm ơn bạn đã truy cập và học tiếng Anh tại Antoree.</td>
                    </tr>
                    <tr height="20">
                        <td></td>
                    </tr>
                    <tr>
                        <td style="line-height: 22px;">
                            Để xác nhận đăng ký bạn vui lòng nhấn vào nút bên dưới truy cập vào đường dẫn sau:<br>
                    ...
                    <tr>
                        <td>
                            <a href="{{ $url_confirm }}" style="background-color: #00ab6b;color: #fff;text-align: center;padding: 16px;border: none;font-weight: 600;cursor: pointer;font-size: 16px; width: 200px;display: block;text-decoration: none;">XÁC NHẬN ĐĂNG KÝ</a>
                        </td>
                    </tr>
                    <tr height="50">
                        <td></td>
                            ...
                            <table width="100%" align="center">
                                <tr>
                                    <td style="color: rgba(56, 64, 71, 0.6); font-size: 12px;line-height: 16px;">
                                        <strong style="color: rgba(56, 64, 71, 0.8); font-size: 14px; font-weight: 600;">Công ty Giáo dục và Đào tạo Antoree International Pte. Ltd.</strong><br>
                                        <span>Văn phòng Hà Nội: tầng 12, tòa nhà Sakura, 47 Vũ Trọng Phụng, quận Thanh Xuân, Hà Nội </span><br>
                                        <span>Trụ sở Singapore: 10 Anson Road #26-04, International Plaza, Singapore 079903. </span>
                                    </td>
