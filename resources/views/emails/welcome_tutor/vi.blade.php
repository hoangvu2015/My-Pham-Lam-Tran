                ...
                <table width="100%" align="justify" style="color: #384047; margin: 0 auto;">
                    ...
                    <tr>
                        <td style="line-height: 22px;">
                            ...
                            <a href="{{ localizedURL('verify/tutor/{id}/{activation_code}',['id' => $id, 'activation_code' => $activation_code]) }}" style="color: #00ab6b; text-decoration: none;font-weight: 600; font-size: 16px;">{{ localizedURL('verify/tutor/{id}/{activation_code}',['id' => $id, 'activation_code' => $activation_code]) }}</a>
                    ...
                    <tr>
                        <td>
                        <a href="{{ localizedURL('verify/tutor/{id}/{activation_code}',['id' => $id, 'activation_code' => $activation_code]) }}" style="background-color: #00ab6b;color: #fff;text-align: center;padding: 16px;border: none;font-weight: 600;cursor: pointer;font-size: 16px; width: 150px;display: block;text-decoration: none;">CONFIRM</a>
                        </td>
                    </tr>
                    <tr height="50">
                        <td></td>
