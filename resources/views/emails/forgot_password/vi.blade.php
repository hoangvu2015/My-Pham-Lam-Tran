                ...
                <table width="100%" align="justify" style="color: #384047; margin: 0 auto;">
                    ...
                    <tr>
                        <td style="line-height: 22px;">
                            Để cập nhật lại mật khẩu, bạn vui lòng nhấn vào nút bên dưới<br>
                        </td>
                    </tr>
                    <tr height="40">
                        <td></td>
                    ...
                    <tr>
                        <td>
                            <a href="{{ localizedURL('password/reset/{token}', ['token' => $token], $site_locale) }}?email={{$user->email}}" style="background-color: #00ab6b;color: #fff;text-align: center;padding: 16px;border: none;font-weight: 600;cursor: pointer;font-size: 16px; display: inline-block; text-decoration: none;">Reset Your Password</a>
                        </td>
                    </tr>
                    <tr height="50">
                        <td></td>
                            ...
                            <table width="100%" align="center">
                                <tr>
                                    <td style="color: rgba(56, 64, 71, 0.6); font-size: 12px;line-height: 16px;">
                                        <strong style="color: rgba(56, 64, 71, 0.8); font-size: 14px; font-weight: 600;">Công ty Giáo dục và Đào tạo Antoree International Ltd.</strong><br>
