            ...
            <ul class="nav navbar-nav">
                <li class="dropdown languages-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <span>{{ currentLocaleNativeReading() }}</span>
                    </a>
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer">
                            <a href="{{ localizedURL('notification') }}">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ $auth_user->profile_picture }}" class="user-image" alt="{{ trans('label.profile_picture') }}">
                        <span class="hidden-xs">{{ $auth_user->name }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="{{ $auth_user->profile_picture }}" class="img-circle" alt="{{ trans('label.profile_picture') }}">
                            <p>
                                {{ $auth_user->name }}
                        ...
                        <li class="user-footer">
                            <div class="pull-right">
                                <a href="{{ localizedURL('auth/logout') }}" class="btn btn-default btn-flat">
