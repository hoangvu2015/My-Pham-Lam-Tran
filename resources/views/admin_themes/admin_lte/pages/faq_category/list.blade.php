    ...
    <div class="col-xs-12">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('form.list_of',['name'=>trans('pages.admin_faq_categories_title')]) }}</h3>
            </div><!-- /.box-header -->
                ...
                <table class="table table-bordered table-hover">
                    ...
                    @foreach($categories as $category)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ localizedAdminURL('faq/categories/{id}/edit', ['id'=> $category->id]) }}">
                                    {{ trans('form.action_edit') }}
                                </a>
                                <a class="delete" href="{{ localizedAdminURL('faq/categories/{id}/delete', ['id'=> $category->id]) }}?{{ $rdr_param }}">
